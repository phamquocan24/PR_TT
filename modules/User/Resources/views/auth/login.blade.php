...
@section('content')
    ...
    <div class="auth-wrapper">
        <a href="javascript:void(0)" class="back-to" title="{{ trans('user::auth.back_to_home') }}">
        ...
        <div class="auth-right">
            ...
            <div class="auth-form-overflow">
                <div class="auth-form">
                    <div class="auth-form-header">
                        ...
                        <div class="auth-form-header-content">
                            <div class="auth-form-header-top">
                                <a href="javascript:void(0)" class="auth-form-header-logo">
                                    <h3>FleetCart</h3>
                                </a>
                            </div>
                    ...
                    <form class="auth-form-body" method="POST" action="{{ route('auth.login.postLogin') }}">
                        {{ csrf_field() }}
                                ...
                                <div class="checkbox-group">
                                    <div class="checkbox">
                                        ...
                                        <span>
                                            ...
                                            <span>{{ trans('user::auth.remember_me') }}</span>
                                        </label>
                                    </div>

                                    <a href="{{ route('auth.reset') }}" class="forgot-password">
